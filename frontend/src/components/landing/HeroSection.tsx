...
const HeroSection = () => {
    ...
    return (
      <div className="relative z-10 grid grid-cols-1 gap-5 lg:grid-cols-2 w-full max-w-7xl mx-auto px-5 py-20 min-h-[100dvh]">
        ...
        <div className="grid items-center text-white max-w-2xl">
          <div className="text-center lg:text-left">
            ...
            <div className="max-w-md">
                ...
                <span> if you want to contribute or self-host it on your own server</span>
            </div>
          </div>
        </div>
