...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 text-white py-12 border-t border-slate-800 relative z-10">
      <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Empowering professionals to master their interviews with AI-driven insights and smart tracking.
          </p>
        </div>
        
        <div>
          <h4 className="font-semibold text-lg mb-4 text-slate-100">Product</h4>
          <ul className="space-y-2 text-slate-400 text-sm">
            <li><Link to="/features" className="hover:text-yellow-300 transition-colors">Features</Link></li>
            <li><Link to="/pricing" className="hover:text-yellow-300 transition-colors">Pricing</Link></li>
            <li><Link to="/testimonials" className="hover:text-yellow-300 transition-colors">Testimonials</Link></li>
          </ul>
        </div>

        <div>
           <h4 className="font-semibold text-lg mb-4 text-slate-100">Company</h4>
           <ul className="space-y-2 text-slate-400 text-sm">
            ...
            <li><Link to="/terms" className="hover:text-yellow-300 transition-colors">Terms of Usage</Link></li>
        ...
        <div>
          ...
          <div className="flex space-x-4">
             ...
             <a target='_blank' href="https://github.com/alankoibagarov/interview-tracker" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-yellow-400 hover:text-slate-900 transition-all">
      ...
      <div className="max-w-7xl mx-auto px-5 mt-12 pt-8 border-t border-slate-800 text-center text-slate-500 text-sm">
